...
Defines the service interface and models for SMS-based phone number verification, allowing users to verify their phone number to increase their trust level.
