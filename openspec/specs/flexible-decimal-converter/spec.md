...
Defines a custom `System.Text.Json` converter that handles deserialization of price fields sent as either JSON number or JSON string tokens, enabling resilient API contract handling.
