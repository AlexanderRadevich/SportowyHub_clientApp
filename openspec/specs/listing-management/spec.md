...
Defines the service interface and models for authenticated listing CRUD operations, including creating, updating, deleting, publishing, hiding, and resubmitting listings via the private API.
